        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <motion.a 
              ...
              className="flex items-center gap-3 rounded-2xl border border-border bg-card/80 backdrop-blur-sm px-5 py-3 transition-all hover:border-secondary/50 hover:shadow-lg"
